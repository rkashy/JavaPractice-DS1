...
public class Main<listOfEmp> {
    ...
    private static void operateEmployee_Map() {
        ...
        //----------------------- Map Demo ------------------------
        MapOperations(empListOfObjects2);
    }
    ...
    private static void MapOperations(ListOfEmployees list1) {
    	
    	System.out.println("\n--------------- Map Demo --------------");
        String[] names = new String[list1.getNumberOfEmployees()];

       for(int counter =0; counter <= names.length -1 ; counter++)
            names[counter] = list1.getEmpName(counter);
        ...
        if(department.containsKey("IT")) {
            ...
            department.put(names[0], "Dept - IT");
            System.out.println(names[0] + " added successfully to Dept - IT");
        }
        department.put(names[1], "Dept - IT");
        department.put(names[2], "Dept - HR");
//        System.out.println(department.put(e4.getEmpName(), "Dept - HR"));
//        System.out.println(department.put(e5.getEmpName(), "Dept - IT"));
        if(department.containsKey(names[0])) {
            System.out.println(names[0] + " is already in the department map");
        } else {
            department.put(names[0], "Added");
        }
